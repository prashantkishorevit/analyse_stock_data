...
stock_below_sma = []  # Creating empty list
...
for i in symbol_list:
    try:
        ...
        if current_closing_price >= current_sma:
            ...
            stock_below_sma.append(i)

    except Exception as e:
        print("Exceptioin ", e)

print("List of stocks currently moving above 200-day SMA:\n", stock_above_sma)
print("List of stocks currently moving below 200-day SMA:\n", stock_below_sma)